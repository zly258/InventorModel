        ...
        try
        {
            ...
            switch(args[0].ToLowerInvariant())
            {
                case "build":
                    ...
                    var output=args.Length>2?Path.GetFullPath(args[2]):Path.ChangeExtension(Path.GetFullPath(args[1]),".ipt");
                ...
                case "render":
                    ...
                    var dir=args.Length>1?Path.GetFullPath(args[1]):Path.Combine(Environment.CurrentDirectory,"views");
